...
def generate_access_config(intf_vlan_mapping, access_template):
    ...
    for k, v in intf_vlan_mapping.items():
        ...
        a = access_template.copy()
        a[1] = a[1]+' '+str(v)
        res.extend(a)

    return res
print('Проверка работы функции на примере словаря access_config и списка команд access_mode_template:')
print( generate_access_config(access_config, access_mode_template) ) 
print('\nПроверка работы функции на примере словаря access_config_2 и списка команд access_mode_template:')   
